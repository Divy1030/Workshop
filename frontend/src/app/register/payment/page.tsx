...
const PaymentPage = () => {
  const AMOUNT = 10000; // ₹250 in paise
    ...
    try {
      ...
      const options = {
        ...
        handler: function (response: any) {
          // Redirect to verification page with success status and payment details
          router.push(`/verification?status=success&payment_id=${response.razorpay_payment_id}&order_id=${response.razorpay_order_id}`);
      ...
      router.push('/verification?status=failed');
      setIsProcessing(false);
    }
  };
