...
export default function ContactDetails() {
  ...
  //checking if the captcha token is verified or not
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      <div className="relative">
        <label className="absolute text-blue-700 text-sm font-medium -top-2 left-4 bg-white px-1">
          Contact Number
        </label>
      ...
      {emailSent && (
        <div className="bg-blue-50 text-blue-700 p-3 rounded-md text-sm">
          ...
          your inbox and click the verification link before proceeding to
          payment.
        </div>
      )}
      ...
      {errors.hostlerOrDayScholar && (
        <p className="text-red-500 text-sm mt-1">
          {errors.hostlerOrDayScholar.message}
        </p>
      )}
