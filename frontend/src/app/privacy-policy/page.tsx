    ...
    return (
      <div className="min-h-screen bg-[#f1eaff] py-10 px-4 flex items-center justify-center">
        <div className="bg-[#b2e0ff] max-w-4xl w-full p-8 rounded-2xl shadow-xl">
          <h1 className="text-2xl font-semibold text-center mb-6">Privacy Policy for CSI Render 3.0 Registration</h1>
          ...
          <div className="space-y-4 text-black">
            ...
            <div>
              ...
              <ul className="list-disc pl-10 mt-2">
                ...
                <li><strong>Company</strong> (referred to as either &ldquo;the Company&rdquo;, &ldquo;We&rdquo;, &ldquo;Us&rdquo; or &ldquo;Our&rdquo; in this Agreement) refers to CSI Render 3.0 Registration.</li>
                ...
                <li><strong>Website</strong> refers to CSI Render 3.0 Registration, accessible from https://render.csiakgec.co.in/</li>
